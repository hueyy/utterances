...
if (script === undefined) {
  ...
  script = document.querySelector('script[src^="https://utterances.huey.xyz/client.js"]') as HTMLScriptElement;
}
...
const utterancesOrigin = script.src.match(/^https:\/\/utterances\.huey\.xyz|https:\/\/huey\.xyz|http:\/\/localhost:\d+/)![0];
